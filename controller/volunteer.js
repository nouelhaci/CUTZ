  ...
  try {
    ...
    if (user) {
      if (eventReservationVolunteer) {
        const clientRecord = await VolunteerRecord.create({
          firstName: eventReservationVolunteer.volunteerID?.firstName,
          lastName: eventReservationVolunteer.volunteerID?.lastName,
          organizationName:
            eventReservationVolunteer.eventID?.orgId?.organizationName,
          eventType: eventReservationVolunteer.eventID?.eventType,
          location: eventReservationVolunteer.eventID?.location,
          addresses: eventReservationVolunteer.eventID?.addresses,
          endTime: "",
          checkIn: eventReservationVolunteer.checkIN,
          checkOut: eventReservationVolunteer.checkOut,
          reservedTime: "",
          attendance: "",
        });
      }
